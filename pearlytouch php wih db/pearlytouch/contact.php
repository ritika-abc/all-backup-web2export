                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="contact-info-item position-relative bg-primary text-center p-3">
                        <div class="border py-5 px-3">
                            ...
                            <h5 class="fw-light text-white text-lowercase fs-6">N.6, Ashok Nagar, Rettavaikkal,
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="contact-info-item  position-relative bg-primary text-center p-3">
                        <div class="border py-5   px-3">
                            ...
                            <h5 class="fw-light text-white"><a href="tel:9344517609" class="text-white">9344517609</a>
                            </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="contact-info-item position-relative bg-primary text-center p-3">
                        <div class="border py-5 px-3">
                            ...
                            <h5 class="fw-light text-white"><a
                                    href="mailto:divinemagicpt520@gmail.com" class="text-white">divinemagicpt520@gmail.com</a> ||
                            </h5>
                            <h5 class="fw-light text-white fs-6"><a href="mailto:delphinarputharaj2023@gmail.com" class="text-white">
                                    delphinarputharaj2023@gmail.com
                                </a>
                            </h5>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-7 wow fadeIn" data-wow-delay="0.1s">
                    <p class="mb-4">We're passionate and committed to providing you with the best information and
                        products to enhance your experience.Thank you for choosing <strong>Pearly Touch </strong>. We
                        look orward to hear from you!</p>
                ...
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.5s">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4013002.0576663823!2d75.64831636899828!3d10.815343380015676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b00c582b1189633%3A0x559475cc463361f0!2sTamil%20Nadu!5e0!3m2!1sen!2sin!4v1715857615504!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
