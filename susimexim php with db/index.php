...
<head>
 ...
 <meta content="width=device-width, initial-scale=1.0" name="viewport">
   <title>Onion Exporters in Sri Lanka || Best Exporter Susilexim </title>
    <meta name="description" content="Discover the best fresh Onion Exporters in Sri Lanka offering high-quality onions at competitive prices, ensuring freshness and timely deliver in worldwide" />
     <meta name="keywords" content="Onion exporters in Sri Lanka , Onion Exporters in Bangladesh , Onion Exporters in Dubai  " />
     <meta name="robots" content="index, follow" />
   <link rel="canonical" href="https://susilexim.co.in/" />

      <!-- Open Graph data -->

  <meta property="og:title" content="Onion Exporters in Sri Lanka || Best Exporter Susilexim "/>
   <meta property="og:description" content="Discover the best fresh Onion Exporters in Sri Lanka offering high-quality onions at competitive prices, ensuring freshness and timely deliver in worldwide" />
   <meta property="og:site_name" content="susilexim" />
   <meta property="og:url" content="https://susilexim.co.in/"/>
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="en_US" />
     <meta name="document-type" content="public">
    <meta name="google-site-verification" content="XabQYx0tWuvyYkLweQNsfI7llxEiu8nZXTzJ8NwSRjw" />
...
<body>
    ...
    <!--                                <h1 class="display-5 mb-5 animated slideInDown">Organic vegetables are Good For-->
    <!--                                    Health</h1>-->
    ...
    <div style="height:60vh;">
         <video src="about.mp4" height="100%" style="object-fit: cover;" width="100%" class="rounded" type="video/mp4" autoplay muted loop></video>
    </div>
...
.bg_fixed img{
animation: w 12s infinite linear
}
@keyframes w {
    0% {
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <!--</div>--> 
                    <!--<div class="bg_fixed" style="background-image: url(air.jpg);background-attachment: fixed;height: 100vh;"></div>-->
                    <div class="bg_fixed" >
                        <img class="img-fluid w-100" src="1.jpg" height="auto" width="100%">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-5 mb-4">About us <strong class="text-success">Susil exim</strong></h1>
                    <p class="mb-4"><q>Susil exim</q> Sri Lanka is renowned for its premium onion exports, with numerous dedicated onion exporters catering to global markets. These exporters ensure that onions are cultivated under optimal conditions, adhering to international standards for quality and freshness. <a href="https://susilexim.co.in/Single-Product.php?id=3">Onion exporters in Sri Lanka</a> provide a variety of onion types, including red, white, and shallots, meeting diverse culinary needs worldwide. With a focus on sustainable farming practices and efficient supply chain management, Sri Lankan onion exporters guarantee timely delivery and competitive pricing. Partner with Sri Lankan onion exporters to experience superior quality and service, enhancing your business's success. variety of flavors to suit every palate, all crafted from 100% pure fruit and vegetable ingredients without any additives or preservatives
                    </p>
                    <p><i class="fa fa-check text-primary me-3"></i>6 years Experience</p>
                    <p><i class="fa fa-check text-primary me-3"></i>BSc.agri degree in Tamilnadu agricultural university,coimbatore</p>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        <div class="icon_box mb-3">
                            <img class="img-fluid  " src="img/icons/why-choose-1.jpg" height="50px" width="50px" alt="image icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        <div class="icon_box mb-3">
                            <img class="img-fluid  " src="img/icons/why-choose-2.jpg" height="50px" width="50px" alt="icon image">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        <div class="icon_box mb-3">
                            <img class="img-fluid  " src="img/icons/why-choose-5.jpg" height="50px" width="50px" alt="Best icon image">
                        </div>
