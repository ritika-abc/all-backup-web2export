<?php include "include/header.php"; ?>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid bg-secondary py-5" style="background-image:url(https://rudrakshglobal.com/image/allmasala.jpg); background-color:black; opacity:0.9;">
                    ...
                    <div class="d-flex flex-column justify-content-center bg-primary h-100 p-5">
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Our Office</h4>
                                <p class="m-0 text-white">09 Sukh sagar colony, near shani mandir Gram Kodriya mhow, 453441</p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Email Us</h4>
                                <p class="m-0 text-white">Abhi87704746@gmail.com</p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Call Us</h4>
                                <p class="m-0 text-white">91 8770474681</p>
                            </div>
                        </div>
                    </div>
                </div>
